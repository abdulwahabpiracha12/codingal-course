# Program to append contents of file in another life
...
# appending the contents of second file to the first file
f1.write(f2.read())
...
# printing the ci=ontents of the files after appending
